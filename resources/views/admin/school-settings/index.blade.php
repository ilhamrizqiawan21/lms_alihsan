...
<form action="{{ route('admin.school-settings.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                <div class="card-header"><i class="bi bi-calendar-check-fill me-2"></i> Akademik & Tema</div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" name="primary_color" class="form-control form-control-color @error('primary_color') is-invalid @enderror" value="{{ old('primary_color', $setting->primary_color) }}" required>
                        @error('primary_color') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Warna Sekunder <span class="text-danger">*</span></label>
                        <input type="color" name="secondary_color" class="form-control form-control-color @error('secondary_color') is-invalid @enderror" value="{{ old('secondary_color', $setting->secondary_color) }}" required>
                        @error('secondary_color') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Warna Sidebar</label>
                        <input type="color" name="sidebar_color" class="form-control form-control-color @error('sidebar_color') is-invalid @enderror" value="{{ old('sidebar_color', $setting->sidebar_color ?: $setting->primary_color) }}">
                        @error('sidebar_color') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-0">
                        <label class="form-label">Warna Navbar</label>
                        <input type="color" name="navbar_color" class="form-control form-control-color @error('navbar_color') is-invalid @enderror" value="{{ old('navbar_color', $setting->navbar_color ?: $setting->primary_color) }}">
                        @error('navbar_color') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                    </div>
                </div>
            </div>
